	...
	<form:form action="/calculateCost" method="post" modelAttribute="ticket">
		...
		<table>
			<tr>
				...
				<td><form:input id="movieName" path="movieName" /></td>
			</tr>
			<tr>
				<td> <form:label path="circleType">Choose Circle:</form:label> </td>
				<td><form:select path="circleType" id="circleType" name="circleType" items="${circleList}" /></td>
			</tr>
			<tr>
				<td> <form:label path="noOfTickets">Number of Tickets</form:label> </td>
				<td><form:input path="noOfTickets" id="noOfTickets" name="noOfTickets"/></td>
			</tr>
			<tr>
				<td>
					<button type="submit" name="submit">CalculateCost</button>
				</td>
			</tr>
		</table>
